...
List<Product> products = [
    ...
    Product(
      ...
      price: 1299.99,
      description: "Lightweight laptop with M3 chip, 13-inch display, and all-day battery life",
    ...
    Product(
      ...
      price: 999.99,
      description: "Ultrabook with Intel Core i7, 16GB RAM, and InfinityEdge display",
    ...
    Product(
      ...
      price: 52999.99,
      description: "Electric SUV with autopilot, 330-mile range, and premium interior",
      image: "https://example.com/images/teslamodely.jpg",
    ),
    Product(
      productName: "Google Pixel 8 Pro",
      price: 899.99,
      description: "AI-powered smartphone with advanced computational photography and pure Android",
      image: "https://example.com/images/pixel8pro.jpg",
    ),
    Product(
      productName: "Surface Pro 9",
      price: 1299.99,
      description: "2-in-1 laptop/tablet with Intel Core i7, detachable keyboard, and Surface Pen",
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text('${product.productName}',style:TextStyle(fontSize: 20),overflow: TextOverflow.ellipsis,),
                    Text('${product.description}',style:TextStyle(fontSize: 15),overflow: TextOverflow.ellipsis, maxLines: 2,),
                  ],
                ),
              ),
